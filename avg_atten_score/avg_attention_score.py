...
try:
    ...
    if not df.empty:
        ...
        df.to_excel(r'C:\Users\piyus\OneDrive\Desktop\coding\FACE UNDER RECO\face_recognition\avg_atten_score\attendance_with_attention_and_average.xlsx', index=False)
