...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Piyush Singh'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel("C:\\Users\\piyus\\OneDrive\\Desktop\\coding\\FACE UNDER RECO\\atten_save\\recognized_faces.xlsx", index=False)
...
if not df.empty:
    df.to_excel("C:\\Users\\piyus\\OneDrive\\Desktop\\coding\\FACE UNDER RECO\\atten_save\\attendance.xlsx", index=False)
